...
% \vfill
\vspace{-.1\paperheight} % this allows overlap
...
\begin{minipage}[c]{.5\paperwidth}
    ...
    \textbf{#1} \newline
    attended the 3\textsuperscript{rd} edtion of Conference for Young Botanists, \newline
    CYBO 2025 in Genova (IT), 5-7 February.
    \vspace{.05\linewidth} \\
    \normalsize The CYBO Organising and Scientific Committees \\
    \vspace{.1\linewidth} \\
    \centering
    % \includesvg[width=.5\paperwidth]{../graphics/certificates/LogoCYBO_2025} \newline
...
\participantlist{\printCertificate}{../certificates/certificates_test.txt}
% Some content
% \tikz[remember picture,overlay] \node[inner sep=0pt] at (current page.center){\includegraphics[width=\paperwidth,height=\paperheight]{graphics/Certficates_background_2024_newdesign.png}};
% \clearpage
% text
