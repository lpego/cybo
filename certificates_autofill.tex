...
\begin{minipage}[c]{.5\paperwidth}
    ...
    Alexandre Antonelli -- "Botanical science to deliver the global biodiversity targets", \newline on April 15\textsuperscript{th}, 2024, online, duration 60 min. 
    \vspace{.05\linewidth} \\ 
...
\participantlist{\printCertificate}{certificate_names_Antonelli.txt}
% Some content
% \tikz[remember picture,overlay] \node[inner sep=0pt] at (current page.center){\includegraphics[width=\paperwidth,height=\paperheight]{graphics/Certficates_background_2024_newdesign.png}};
% \clearpage
% text
