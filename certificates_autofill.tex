...
\begin{minipage}[c]{.5\paperwidth}
    ...
    \vspace{.05\linewidth} \\     
    \Large We hereby certify that \newline \textbf{#1} \newline attended the 1\textsuperscript{st} CYBO Webinar 2024 \newline by: \newline 
    Federico Riva -- "Habitat loss VS Fragmentation: understanding the role of small habitat patches for biodiversity conservation", \newline on May 10\textsuperscript{th}, 2024, online, duration 60 min. 
    \vspace{.05\linewidth} \\ 
...
\participantlist{\printCertificate}{certificate_names_Riva.txt}
% Some content
% \tikz[remember picture,overlay] \node[inner sep=0pt] at (current page.center){\includegraphics[width=\paperwidth,height=\paperheight]{graphics/Certficates_background_2024_newdesign.png}};
% \clearpage
% text
